...
class Ves_BlockBuilder_Adminhtml_BlockbuilderController extends Mage_Adminhtml_Controller_Action {
        ...
        if ($post_data) {
            ...
            try {
                ...
                if ($this->getRequest()->getParam("duplicate")) {
                    ...
                    $post_data['shortcode'] = Mage::helper("ves_blockbuilder")->getShortCode("ves_blockbuilder/widget_builder", $this->getRequest()->getParam("id"));
    ...
    public function importCsvAction() {
         // get uploaded file
        $filepath = Mage::helper("ves_blockbuilder")->getUploadedFile();
