...
function openImageManager2(obj, field_id) {
	var src = jQuery('#filemanager-container iframe').eq(0).data("src");
	var current_iframe_field_id = jQuery('#filemanager-container iframe').eq(0).data("field_id");
	if(current_iframe_field_id != field_id){
		src = src.replace("__FIELD_ID__", field_id);
    	jQuery('#filemanager-container iframe').eq(0).attr("src", src);
    	jQuery('#filemanager-container iframe').eq(0).data("field_id", field_id);
	}

    jQuery("#filemanager-container").show();
    jQuery("#row_settings").hide();
    jQuery("#column_settings").hide();
    jQuery("#widget_settings").hide();
    //jQuery('#filemanager-modal').modal('show');
}

function openImageManager(obj, field_id) {
	var src = jQuery('#filemanager-fancybox').data("src"),
              fancybox_width = jQuery('#filemanager-fancybox').data("width"),
              fancybox_height = jQuery('#filemanager-fancybox').data("height");
    ...
    src = src.replace("__FIELD_ID__", field_id);
    jQuery('#filemanager-fancybox').attr("href", src);
    ...
    jQuery("#filemanager-container").show();
    /*
    jQuery('#filemanager-fancybox').fancybox({
    ...
    jQuery('#filemanager-modal').modal('show');
    //jQuery('#filemanager-fancybox').trigger('click');
